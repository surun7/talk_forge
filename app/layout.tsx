  ...
  return (
    ...
    >
      ...
      <body className="h-full font-sans antialiased">
        <LocaleProvider>
          {children}
          <footer className="flex items-center justify-center gap-2 h-8 text-[10px] text-slate-400 dark:text-slate-500 border-t border-slate-200 dark:border-slate-800 print:hidden">
